...
export const ownerMenuLinks = [
    ...
    { name: "Add Owner", path: "/owner/add-owner", icon: users_icon, coloredIcon: cautionIconColored },
    { name: "Add Driver", path: "/owner/add-driver", icon: carIconColored, coloredIcon: cautionIconColored }
]

// Remove hardcoded admin data - now fetched from Spring Boot backend
export const getDefaultUserData = () => ({
  "_id": "default_user_id",
  "name": "User", // This will be replaced with actual data from backend

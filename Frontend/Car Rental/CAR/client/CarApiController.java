...
@CrossOrigin(origins = {"http://localhost:5173","http://localhost:3000","http://127.0.0.1:5500","http://localhost:5173"})
public class CarApiController {
  ...
  public List<Car> getCarsByOwner(@PathVariable Integer ownerId) {
    return carService.getCarsByUserId(ownerId.longValue());
  }
